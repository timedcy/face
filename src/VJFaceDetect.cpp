...
/*************************************************************************************************************/
AAM_Shape VJfacedetect::Detect(const IplImage* image, const AAM_Shape& MeanShape)
{
...
void VJfacedetect::AdjustViolaJonesShape(AAM_Shape &Shape)
{
...
void VJfacedetect::AlignToViolaJones(AAM_Shape &StartShape, 
